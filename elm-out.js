...
var $author$project$ColorPicker$update = F2(
	function (msg, model) {
		var _v0 = $the_sett$elm_color$Color$toRgb(model.color);
		var red = _v0.red;
		var green = _v0.green;
		var blue = _v0.blue;
		var newColor = msg.a;
...
var $author$project$ColorPicker$UpdateColor = function (a) {
	return {$: 'UpdateColor', a: a};
};
var $author$project$ColorPicker$blueToColour = F2(
	function (color, newBlue) {
...
var $author$project$ColorPicker$toInt = F2(
	function (defaultValue, strValue) {
		return A2(
...
var $author$project$ColorPicker$colorSlider = F3(
	function (name, colorValue, toMsg) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$name('color' + name),
							$elm$html$Html$Attributes$min('0'),
							$elm$html$Html$Attributes$max('255'),
							$elm$html$Html$Attributes$value(
							$elm$core$String$fromInt(colorValue)),
							$elm$html$Html$Events$onInput(
							A2(
								$elm$core$Basics$composeL,
								toMsg,
								$author$project$ColorPicker$toInt(colorValue)))
						]),
					_List_Nil),
					A2(
					$elm$html$Html$span,
...
var $author$project$ColorPicker$greenToColour = F2(
	function (color, newGreen) {
		var _v0 = $the_sett$elm_color$Color$toRgb(color);
		var red = _v0.red;
		var green = _v0.green;
		var blue = _v0.blue;
		return A3($the_sett$elm_color$Color$rgb, red, newGreen, blue);
	});
var $author$project$ColorPicker$redToColour = F2(
	function (color, newRed) {
		var _v0 = $the_sett$elm_color$Color$toRgb(color);
		var red = _v0.red;
		var green = _v0.green;
		var blue = _v0.blue;
	...
	function (color, toMsg) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A3(
					$author$project$ColorPicker$colorSlider,
					'Red',
					red,
					A2(
						$elm$core$Basics$composeL,
						toMsg,
						$author$project$ColorPicker$redToColour(color))),
					A3(
					$author$project$ColorPicker$colorSlider,
					'Green',
					green,
					A2(
						$elm$core$Basics$composeL,
						toMsg,
						$author$project$ColorPicker$greenToColour(color))),
					A3(
					$author$project$ColorPicker$colorSlider,
					'Blue',
					blue,
					A2(
						$elm$core$Basics$composeL,
						toMsg,
						$author$project$ColorPicker$blueToColour(color))),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							'background-color',
							$author$project$ColorPicker$toColorCss(color))
						]),
					_List_Nil)
				]));
	});
var $author$project$ColorPicker$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A2($author$project$ColorPicker$colorPicker, model.color, $author$project$ColorPicker$UpdateColor)
			]));
};
