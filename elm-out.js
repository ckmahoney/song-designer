...
var $author$project$Components$svg = function (name) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$src('/svg/bell.svg')
			]),
		_List_Nil);
};
var $author$project$Components$cardContent = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Components$svg('bell')
										]))
								])),
							A2(
							$elm$html$Html$div,
...
var $author$project$Components$cardImage = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('image is-4by3')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Components$card = function (title) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Components$cardImage,
				A2($author$project$Components$cardContent, title, 'the content')
			]));
};
var $author$project$Instrument$dutyString = function (duty) {
	if (duty.$ === 'Structure') {
		return 'structure';
	} else {
		return 'expression';
...
var $author$project$Instrument$DutyChange = function (a) {
	return {$: 'DutyChange', a: a};
};
var $author$project$Instrument$Expression = {$: 'Expression'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Instrument$DutyChange($author$project$Instrument$Structure))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Instrument$dutyString($author$project$Instrument$Structure))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Instrument$DutyChange($author$project$Instrument$Expression))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Instrument$dutyString($author$project$Instrument$Expression))
					]))
			]));
};
		...
		A2(
			...
			function (x) {
				return A2(
					...
					_List_fromArray(
						[
							$author$project$Components$card(
							$author$project$Instrument$dutyString(model.duty)),
							$author$project$Instrument$editDuty(model.duty)
						]));
			},
			_List_fromArray(
				[0, 1, 2, 3, 4])));
...
_Platform_export({'Components':{'init':_VirtualDom_init($author$project$Components$main)(0)(0)},'Main':{'init':$author$project$Main$main(
